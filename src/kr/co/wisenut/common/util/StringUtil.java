...
public class StringUtil {
	 ...
	 * @return
	 */
	public static String replaceAllWebCrawler(String str) {
		String val = str; // 
		//val = val.replaceAll("\\\"","\\\\\"");	  // " 
		//val = val.replaceAll("\\\'","\\\\\'");	  // '
		//val = val.replaceAll("\"", "");	  // '
		//val = val.replaceAll("\\\\","");
		// 미리 변경되는 경우가 있어서 강제로 변경
	...
	public static void main(String[] args) {
		String a = "LH는 충남 아산시 소재 LH 아산에너지사업단에서 전기차 충전설비 전문업체 '대영채비'와 함께 친환경 복합 전기충전 플랫폼 실증단지 개소식을 개최했다고 1일 밝혔다.";
		//String a= "asdf'";
		System.out.println(a);
		//String b= StringUtil.replace(a, "\"", "\\\"");
		String b = StringUtil.replaceAllWebCrawler(a);
